...
def put_data_in_dynamodb(full_video_name, video_s3_key, transcribe_ouput_s3_key):
    ...
    try:
        ...
        therapist_code, room_num, patient_code, meeting_num, camera_name, date, time, is_video = extract_data_from_file_name(full_video_name)
...
def lambda_handler(event, context):
    ...
    full_video_name_without_ext, file_ext = full_video_name.split(".")
